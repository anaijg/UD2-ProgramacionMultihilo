...
/**
 * En el main se crean dos hilos (workers) visibles
 * y otros dos invisibles y se comprueba si hay diferencia en el resultado.
 *
 */
public class Main {
        public static void main(String[] args) {
            ...
            Thread hiloInvisible1 = new Thread(new TaskInvisible(ejemploInvisible), "Hil Invisible->1");
            ...
            System.out.println("Valor final Invisible: " + ejemploInvisible.getNumero());
            System.out.println("Valor final Visible: " + ejemploVisible.getNumero());
        }
    }
