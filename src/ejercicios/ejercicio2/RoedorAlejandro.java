...
public class RoedorAlejandro implements Runnable{
    private String nombre;
    private int tiempoEnComer;
    private Color color;
    private Emoji emoji;

    public RoedorAlejandro(String nombre, int tiempoEnComer, Color color, Emoji emoji) {
        this.nombre = nombre;
...
class MainRoedores{
    public static void main(String[] args) {
        // creamos los ratones
        RoedorAlejandro taskFievel = new RoedorAlejandro("Fievel", 4, Color.BLACK, Emoji.RAT);
        RoedorAlejandro taskJerry = new RoedorAlejandro("Jerry", 5, Color.GREEN, Emoji.CHIPMUNK);
        RoedorAlejandro taskPinky = new RoedorAlejandro("Pinky", 3, Color.RED, Emoji.MOUSE);
        RoedorAlejandro taskMickey = new RoedorAlejandro("Mickey", 6, Color.YELLOW, Emoji.HAMSTER);
