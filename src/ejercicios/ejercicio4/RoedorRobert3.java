...
import ejercicios.ejercicio3.RoedorRobert2;
import utilidades.Color;
import utilidades.Emoji;

import java.util.Scanner;

public class RoedorRobert3 implements Runnable {
    private String nombre;
    private int tiempoEnComer;
    private Color color;
    private Emoji emoji;

    public RoedorRobert3(String nombre, int tiempoEnComer, Color color, Emoji emoji) {
        this.nombre = nombre;
    ...
    public static void iniciarRoedoresSinEsperar() {
        ...
        RoedorRobert3 taskFievel = new RoedorRobert3("Fievel", 4, Color.BLACK, Emoji.RAT);
        RoedorRobert3 taskJerry = new RoedorRobert3("Jerry", 5, Color.GREEN, Emoji.CHIPMUNK);
        RoedorRobert3 taskPinky = new RoedorRobert3("Pinky", 3, Color.RED, Emoji.MOUSE);
        RoedorRobert3 taskMickey = new RoedorRobert3("Mickey", 6, Color.YELLOW, Emoji.HAMSTER);
